...
class Spider(Spider):
    sources = {
        's1': {'name': '🎬天堂', 'api': 'http://caiji.dyttzyapi.com/api.php/provide/vod/from/dyttm3u8/at/json'},
        ...
        's16': {'name': '📺如意', 'api': 'https://cj.rycjapi.com/api.php/provide/vod/'},
        ...
        's35': {'name': '📺西瓜', 'api': 'https://caiji.xgzyapi.com/api.php/provide/vod/'},
        's36': {'name': '📺98资源', 'api': 'https://98zy.vip/api.php/provide/vod/'},
        's37': {'name': '🦊火狐', 'api': 'https://hhzyapi.com/api.php/provide/vod/'},
        's38': {'name': '📺大众', 'api': 'https://cdn.dzzyapi.com/api.php/provide/vod/'},
    }
